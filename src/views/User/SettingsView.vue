...
<script>
import UserInfoPanel from "@/components/User/Panels/Settings/UserInfoPanel.vue";
import PersonalSettingsPanel from "@/components/User/Panels/Settings/PersonalSettingsPanel.vue";
import PushSettingsPanel from "@/components/User/Panels/Settings/PushSettingsPanel.vue";
import CommentSettingsPanel from "@/components/User/Panels/Settings/CommentSettingsPanel.vue";
import BookSettingsPanel from "@/components/User/Panels/Settings/BookSettingsPanel.vue";
import UploadPanel from "@/components/User/Panels/Settings/UploadPanel.vue";
