  ...
  <div class="book-item">
    <div class="book-cover" v-bind:style="'background-image:url(' +book.cover+ ')'">
      ...
      <div class="book-detailed">
        ...
        <router-link v-bind:to="'/settings/upload?'+book.type+'='+book.id" class="edit">
    ...
    book: {
      default: function () {
        return {
          ...
          type: "novelid",
          title: "胖次群的奇妙日常",
          cover: "/public/bookUndefined.png",
          publisher: "胖次Group",
          update_time: 23123123,
          author: "Ero Devs",
  ...
  methods: {
    deleteClick () {
      ...
      if (this.book.type === "novelid") {
        ...
        fetch(this.$config.api_base + "novel/subscribe/" + this.book.id, {
          method: "delete",
          credentials: "include",
          headers: {
            Authorization: "Bearer " + jwt
