  ...
  <div class="settings">
    ...
    <div class="panel settings-panel">
      <div class="control-group">
        <label>附件</label>
        <input type="file" @change="updateCover($event)" accept="image/png, image/jpeg, image/bmp" />
      </div>
      <div class="control-group">
        <label>上传结果：</label>
        <input type="text" title="file" value v-model="file" />
      </div>
      <br />
      <br />
      <div v-if="currentTab === 'tab1'">
        <div class="control-group">
          <label>标题</label>
          <div class="controls">
            <input type="text" title="标题" value v-model="archive.title" />
          </div>
        </div>
        <div class="control-group">
          <label>封面地址</label>
          <div class="controls">
            <input type="text" title="封面地址" value v-model="archive.cover" />
          </div>
        ...
        <div class="control-group">
          <label>日文标题</label>
          <div class="controls">
            <input type="text" title="日文标题" value v-model="archive.jptitle" />
          </div>
        </div>
        <div class="control-group">
          <label>作者</label>
          <div class="controls">
            <input type="text" title="作者" value v-model="archive.author" />
          </div>
        </div>
        <div class="control-group">
          <label>内容</label>
        ...
        <div class="control-group">
          <label>Tags</label>
          <div class="controls">
            <input type="text" title="Tags" value v-model="archive.tags" />
          </div>
      ...
      <div v-if="currentTab === 'tab2'">
        <div class="control-group">
          <label>标题</label>
          <div class="controls">
            <input type="text" title="标题" value v-model="novel.title" />
          </div>
        </div>
        <div class="control-group">
          <label>封面地址</label>
          <div class="controls">
            <input type="text" title="封面地址" value v-model="novel.cover" />
          </div>
          <label class="tips">HTTP地址哟</label>
        </div>
        ...
        <div class="control-group">
          <label>作者</label>
          <div class="controls">
            <input type="text" title="作者" value v-model="novel.author" />
          </div>
        </div>
        ...
        <div class="control-group">
          <label>Tags</label>
          <div class="controls">
            <input type="text" title="Tags" value v-model="novel.tags" />
          </div>
          <label class="tips">使用 / 分割</label>
        </div>
        <div class="controls actions">
      ...
      <div v-if="currentTab === 'tab3'">
        <div class="control-group">
          <label>小说ID</label>
          <div class="controls">
            <input type="text" title="小说ID" value v-model="volume.novelid" />
          </div>
        </div>
        <div class="control-group">
          <label>封面地址</label>
          <div class="controls">
            <input type="text" title="封面地址" value v-model="volume.cover" />
          </div>
          <label class="tips">HTTP地址哟</label>
        </div>
        ...
        <div class="control-group">
          <label>标题</label>
          <div class="controls">
            <input type="text" title="标题" value v-model="volume.title" />
          </div>
        </div>
      ...
      <div v-if="currentTab === 'tab4'">
        <div class="control-group">
          <label>分类名称</label>
          <div class="controls">
            <input type="text" title="作者" value v-model="category" />
          </div>
          <div class="controls actions">
  ...
  methods: {
    ...
    CreateArchive () {
      ...
      if (this.archive.id === 0) {
        url = this.$config.api_base + "archive/";
        var m = "POST";
      } else {
        url = this.$config.api_base + "archive/" + this.archive.id;
        m = "put";
      }
      fetch(url, {
        method: m,
    ...
    CreateNovel () {
      ...
      let url;
      if (this.novel.id === 0) {
        url = this.$config.api_base + "novel/";
        var m = "POST";
      } else {
        url = this.$config.api_base + "novel/" + this.novel.id;
        m = "put";
      }
      fetch(url, {
        method: m,
